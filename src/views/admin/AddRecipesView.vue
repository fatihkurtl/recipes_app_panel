...
<template>
    <AdminLayout>
        <div class="dark:bg-gray-800 rounded-lg py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form @submit.prevent="addRecipe" class="space-y-8">
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input @change="handleRecipeFile($event)"
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg p-2.5 cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
