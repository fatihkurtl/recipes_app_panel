...
import RecipesInfoCard from "@/components/local/home/RecipesInfoCard.vue";
...
<template>
  <AdminLayout>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 grid-rows-2 min-w-full">
