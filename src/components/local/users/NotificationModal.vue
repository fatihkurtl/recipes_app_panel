...
const handleNofiticationFile = (event: any) => {
    ...
    if (!imagesRegex.test(event.target.files[0].name)) {
        ...
        switch (activeTab.value) {
            case 'tr':
                notificationData.tr.thumbnail = event.target.files
                break;
            case 'en':
                notificationData.en.thumbnail = event.target.files
                break;
        }
    }
}
                ...
                <form @submit.prevent="sendPushNotification" class="p-4 md:p-5" id="tr-form" role="tabpanel"
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="title" id="title" v-model="notificationData.tr.title"
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input @change="handleNofiticationFile($event)"
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <select id="category" v-model="notificationData.tr.category"
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea v-model="notificationData.tr.description" id="description" rows="4"
                ...
                <form @submit.prevent="sendPushNotification" class="p-4 md:p-5" id="en-form" role="tabpanel"
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="title"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Title</label>
                            <input type="text" name="title" id="title" v-model="notificationData.en.title"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Type notification title" required>
                        </div>
                        <div class="col-span-2 sm:col-span-1">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="category"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category</label>
                            <select id="category" v-model="notificationData.en.category"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option value="">Select category</option>
                                <option value="TV">TV/Monitors</option>
                                <option value="PC">PC</option>
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea v-model="notificationData.en.description" id="description" rows="4"
                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Write notification description here"></textarea>
                        </div>
                    </div>
